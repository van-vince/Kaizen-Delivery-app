          ...
          <View style = {styles.home}>
            ...
            <View style = {styles.view1}>
              <View style ={styles.view8}>
                <Text style = {styles.text2}>Delight customers with speed, quality, & reliability</Text>
          ...
          <View style = {styles.view0}>
            ...
            <View style = {{alignItems:'center', justifyContent:'center', paddingBottom: 15}}> 
                ...
                ref={_map}
                  ...
                  initialRegion = {{...carsAround[0], latitudeDelta:0.05, longitudeDelta:0.05}}
                >
            ...
            <View style = {styles.view5}>
                <View style = {styles.view6}>
                  <View style = {styles.view7}>
                    ...
                    <View>
                      <Text style = {{fontSize:18, color:colors.black,}}>32 Olivia Road</Text>
                      <Text style = {{color:colors.grey3,}}>Teshie, 18-r Accra</Text>
                    </View>
                </View>
                <View>
                <Icon type = 'material-community'
            ...
            <View style = {{...styles.view5, borderBottomWidth:0}}>
                <View style = {styles.view6}>
                  <View style = {styles.view7}>
                    ...
                    <View>
                      <Text style = {{fontSize:18, color:colors.black,}}>56 Tsueiblo Road</Text>
                      <Text style = {{color:colors.grey3,}}>Tsuibleo-manet road, 15-n Accra</Text>
                    </View>
                </View>
                <View>
                <Icon type = 'material-community'
