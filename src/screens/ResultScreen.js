...
const ResultScreen = ({ navigation, route }) => {
  ...
  useEffect(() => {
    ...
    setUserTravelTime ({distance:travelTime.distance, duration:travelTime.duration})
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.modalView}>
        <Text style={{ textAlign: "center", paddingBottom: 20, fontSize: 18 }}>
          Select a Courier - {userTravelTime?.distance?.text}
        </Text>
        <View style={{ margin: 5, height: 180 }}>
          <FlatList
            data={data}
            ...
            renderItem={({ item: { id, title, multiplier, image }, item }) => (
              <TouchableOpacity
                ...
                // style={ id === selected?.id ? {backgroundColor: '#F5F5F5'}: {} }
              style={styles.view9}
              >
                <Image
                ...
                <View>
                  ...
                  <Text style={{ fontSize: 12, color: 'gray'}}>{userTravelTime?.duration?.text} travel time</Text>
                </View>
